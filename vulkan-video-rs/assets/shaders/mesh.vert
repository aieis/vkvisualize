...
void main() {
    ...
    vec3  camera_dir = normalize(vec3(0, -0.6, 1));
    ...
    float y_r      = cam_y_comp * sin_x + pos.y * cos_x;
    float y_comp_r = cam_y_comp * cos_x - pos.y * sin_x;
    float x_r      = pos.x / cam_y_comp * y_comp_r;
    float z_r      = pos.z / cam_y_comp * y_comp_r;
